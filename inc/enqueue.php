...
function voyager_starter_scripts() {
	...
	wp_enqueue_style( 'voyager-style', get_template_directory_uri() . '/dist/css/voyager.min.css', array(), filemtime( get_template_directory() . '/assets/css/voyager.css' ) );
	...
	wp_enqueue_script( 'voyager-starter-js',  get_template_directory_uri() . '/dist/js/script.min.js', array('jquery'), null, true );
