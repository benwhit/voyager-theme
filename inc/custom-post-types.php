...
function pets() {
	$labels = array(
		...
		'add_new'               => __( 'Add New Pet', 'text_domain' ),
		...
		'view_items'            => __( 'View Pets', 'text_domain' ),
		'search_items'          => __( 'Search Pet', 'text_domain' ),
...
function volunteer() {
	...
	$args = array(
		'label'                 => __( 'Volunteer', 'text_domain' ),
		'description'           => __( 'Post Type Description', 'text_domain' ),
		'labels'                => $labels,
