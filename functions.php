<?php
/**
 * Voyager Theme functions and definitions
 *
...
function voyager_theme_setup() {
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'voyager-theme' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'voyager_theme_custom_background_args', array(
...
function voyager_theme_scripts() {
	wp_enqueue_style( 'voyager-theme-style', get_stylesheet_uri() );
